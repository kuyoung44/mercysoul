...
app.post('/api/magnetic/interaction',(req,res)=>res.json({ok:true,requestId:req.requestId,...trackMagneticInteraction({type:req.body?.type,source:req.body?.source||'social-network'})}));
...
// SmartThings: production linking uses OAuth 2.0; tokens are kept server-side and never returned to the client.
